...
import net.bukkit.elementalmaster.procedures.ManaBar3on5DisplayOverlayIngameProcedure;
...
public class ManaBar3on5Overlay extends ElementalmasterModElements.ModElement {
	public ManaBar3on5Overlay(ElementalmasterModElements instance) {
		super(instance, 475);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (ManaBar3on5DisplayOverlayIngameProcedure.executeProcedure(ImmutableMap.of("entity", entity))) {
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("elementalmaster:textures/manabackground3on5.png"));
