...
import net.bukkit.elementalmaster.procedures.ManaBar5on5DisplayOverlayIngameProcedure;
...
public class ManaBar5on5Overlay extends ElementalmasterModElements.ModElement {
	public ManaBar5on5Overlay(ElementalmasterModElements instance) {
		super(instance, 477);
	}
	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (ManaBar5on5DisplayOverlayIngameProcedure.executeProcedure(ImmutableMap.of("entity", entity))) {
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("elementalmaster:textures/manabackground5on5.png"));
