...
public class IceAspectEnchantment extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:ice_aspect")
	public static final Enchantment enchantment = null;
	public IceAspectEnchantment(ElementalmasterModElements instance) {
		super(instance, 658);
	}
