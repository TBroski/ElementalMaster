...
public class IceStalagtitePower3RightClickedInAirProcedure extends ElementalmasterModElements.ModElement {
	public IceStalagtitePower3RightClickedInAirProcedure(ElementalmasterModElements instance) {
		super(instance, 591);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure IceStalagtitePower3RightClickedInAir!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure IceStalagtitePower3RightClickedInAir!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure IceStalagtitePower3RightClickedInAir!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure IceStalagtitePower3RightClickedInAir!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure IceStalagtitePower3RightClickedInAir!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure IceStalagtitePower3RightClickedInAir!");
			return;
		}
