...
public class MagicBallShot2WhileBulletFlyingTickProcedure extends ElementalmasterModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (world instanceof ServerWorld) {
			((ServerWorld) world).spawnParticle(ParticleTypes.WITCH, x, y, z, (int) 6, 0.5, 0.5, 0.5, 1);
		}
		if (world instanceof ServerWorld) {
			((ServerWorld) world).spawnParticle(ParticleTypes.PORTAL, x, y, z, (int) 4, 0.5, 0.5, 0.5, 1);
		}
		if (world instanceof ServerWorld) {
			((ServerWorld) world).spawnParticle(ParticleTypes.END_ROD, x, y, z, (int) 2, 0.5, 0.5, 0.5, 1);
		}
	}
}
