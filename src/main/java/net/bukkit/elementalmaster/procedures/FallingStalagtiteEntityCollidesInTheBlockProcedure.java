...
public class FallingStalagtiteEntityCollidesInTheBlockProcedure extends ElementalmasterModElements.ModElement {
	public FallingStalagtiteEntityCollidesInTheBlockProcedure(ElementalmasterModElements instance) {
		super(instance, 433);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure FallingStalagtiteEntityCollidesInTheBlock!");
			return;
		}
		...
		if ((((((entity.getPersistentData().getString("SelectedPower"))).equals("\u00A7bIce Stalagtite \u00A7fLvl 1"))
			...
			entity.attackEntityFrom(DamageSource.FALLING_BLOCK, (float) 12);
