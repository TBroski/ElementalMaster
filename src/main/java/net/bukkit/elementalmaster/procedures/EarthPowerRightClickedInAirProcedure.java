...
public class EarthPowerRightClickedInAirProcedure extends ElementalmasterModElements.ModElement {
	public EarthPowerRightClickedInAirProcedure(ElementalmasterModElements instance) {
		super(instance, 538);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure EarthPowerRightClickedInAir!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure EarthPowerRightClickedInAir!");
			return;
		}
