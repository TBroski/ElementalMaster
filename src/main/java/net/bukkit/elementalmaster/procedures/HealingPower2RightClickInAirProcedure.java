...
public class HealingPower2RightClickInAirProcedure extends ElementalmasterModElements.ModElement {
	public HealingPower2RightClickInAirProcedure(ElementalmasterModElements instance) {
		super(instance, 586);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure HealingPower2RightClickInAir!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure HealingPower2RightClickInAir!");
			return;
		}
