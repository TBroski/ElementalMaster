...
public class EarthPower2RightClickedInAirProcedure extends ElementalmasterModElements.ModElement {
	public EarthPower2RightClickedInAirProcedure(ElementalmasterModElements instance) {
		super(instance, 606);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure EarthPower2RightClickedInAir!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure EarthPower2RightClickedInAir!");
			return;
		}
