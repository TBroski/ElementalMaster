...
public class LightShotRangedItemUsedProcedure extends ElementalmasterModElements.ModElement {
	public LightShotRangedItemUsedProcedure(ElementalmasterModElements instance) {
		super(instance, 555);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LightShotRangedItemUsed!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure LightShotRangedItemUsed!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LightShotRangedItemUsed!");
			return;
		}
