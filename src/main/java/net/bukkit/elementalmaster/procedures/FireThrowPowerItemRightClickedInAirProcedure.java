...
import net.bukkit.elementalmaster.item.FireThrowPowerItem;
...
public class FireThrowPowerItemRightClickedInAirProcedure extends ElementalmasterModElements.ModElement {
	public FireThrowPowerItemRightClickedInAirProcedure(ElementalmasterModElements instance) {
		super(instance, 534);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity.getCapability(ElementalmasterModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (world instanceof World && !world.getWorld().isRemote && entity instanceof LivingEntity) {
				FireThrowPowerItem.shoot(world.getWorld(), (LivingEntity) entity, new Random(), (float) 1, (float) 4, (int) 1);
			}
		}
	}
}
