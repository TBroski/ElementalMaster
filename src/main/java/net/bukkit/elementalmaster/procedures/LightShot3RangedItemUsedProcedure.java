...
public class LightShot3RangedItemUsedProcedure extends ElementalmasterModElements.ModElement {
	public LightShot3RangedItemUsedProcedure(ElementalmasterModElements instance) {
		super(instance, 609);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LightShot3RangedItemUsed!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			System.err.println("Failed to load dependency itemstack for procedure LightShot3RangedItemUsed!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LightShot3RangedItemUsed!");
			return;
		}
