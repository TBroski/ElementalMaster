...
import net.bukkit.elementalmaster.procedures.FireZombiePlayerCollidesWithThisEntityProcedure;
...
public class FireZombieEntity extends ElementalmasterModElements.ModElement {
	public static EntityType entity = null;
	public FireZombieEntity(ElementalmasterModElements instance) {
		super(instance, 201);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("firezombie").setRegistryName("firezombie");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -16751104, -3407872, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("firezombie"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("elementalmaster:firiumforest")))
				biomeCriteria = true;
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 35, 1, 1));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelzombiemodel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("elementalmaster:textures/fire_zombiee.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				FireZombiePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
