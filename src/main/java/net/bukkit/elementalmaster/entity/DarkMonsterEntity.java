...
import net.bukkit.elementalmaster.procedures.DarkMonsterPlayerCollidesWithThisEntityProcedure;
...
public class DarkMonsterEntity extends ElementalmasterModElements.ModElement {
	public static EntityType entity = null;
	public DarkMonsterEntity(ElementalmasterModElements instance) {
		super(instance, 202);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("darkmonster")
						.setRegistryName("darkmonster");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -16777216, -13421773, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("darkmonster"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 60, 1, 3));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelzombiemodel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("elementalmaster:textures/darkzombie.png");
				}
			};
		});
	}
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				DarkMonsterPlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
