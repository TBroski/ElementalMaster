...
public class MummyEntity extends ElementalmasterModElements.ModElement {
	public static EntityType entity = null;
	public MummyEntity(ElementalmasterModElements instance) {
		super(instance, 206);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -3355648, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("mummy"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("elementalmaster:lightdesert")))
				biomeCriteria = true;
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("desert")))
				biomeCriteria = true;
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 40, 1, 3));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelzombiemodel(), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("elementalmaster:textures/mummy.png");
				}
			};
		});
	}
