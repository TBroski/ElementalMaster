...
public class IcyPineTreeStructure extends ElementalmasterModElements.ModElement {
	public IcyPineTreeStructure(ElementalmasterModElements instance) {
		super(instance, 533);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 750000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("elementalmaster", "icypinetree"));
						if (template == null)
							return false;
