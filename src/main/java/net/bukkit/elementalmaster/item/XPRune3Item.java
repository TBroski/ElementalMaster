...
public class XPRune3Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:xprune3")
	public static final Item block = null;
	public XPRune3Item(ElementalmasterModElements instance) {
		super(instance, 116);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Gain randomly some more XP even more frequently when in Inventory!"));
