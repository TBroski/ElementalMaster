...
public class LuckRuneItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:luckrune")
	public static final Item block = null;
	public LuckRuneItem(ElementalmasterModElements instance) {
		super(instance, 117);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Grants you \u00A74Luck III \u00A7fwhen in Inventory!"));
