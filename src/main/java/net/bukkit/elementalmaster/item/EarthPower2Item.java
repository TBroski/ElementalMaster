...
public class EarthPower2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:earth_power_2")
	public static final Item block = null;
	public EarthPower2Item(ElementalmasterModElements instance) {
		super(instance, 228);
	}
