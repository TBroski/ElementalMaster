...
public class LightningHoeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightninghoe")
	public static final Item block = null;
	public LightningHoeItem(ElementalmasterModElements instance) {
		super(instance, 148);
	}
