...
public class DiamondSpikeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:diamondspike")
	public static final Item block = null;
	public DiamondSpikeItem(ElementalmasterModElements instance) {
		super(instance, 104);
	}
