...
public class MagicLaserPower3Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:magic_laser_power_3")
	public static final Item block = null;
	public MagicLaserPower3Item(ElementalmasterModElements instance) {
		super(instance, 244);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_laser_power_3");
		}
