...
public class NaturePower2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:nature_power_2")
	public static final Item block = null;
	public NaturePower2Item(ElementalmasterModElements instance) {
		super(instance, 231);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("nature_power_2");
		}
