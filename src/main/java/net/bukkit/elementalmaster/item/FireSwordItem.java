...
public class FireSwordItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firesword")
	public static final Item block = null;
	public FireSwordItem(ElementalmasterModElements instance) {
		super(instance, 130);
	}
