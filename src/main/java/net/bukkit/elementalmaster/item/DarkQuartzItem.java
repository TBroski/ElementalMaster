...
public class DarkQuartzItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_quartz")
	public static final Item block = null;
	public DarkQuartzItem(ElementalmasterModElements instance) {
		super(instance, 126);
	}
