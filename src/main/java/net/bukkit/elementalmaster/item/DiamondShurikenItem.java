...
public class DiamondShurikenItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:diamondshuriken")
	public static final Item block = null;
	@ObjectHolder("elementalmaster:entitybulletdiamondshuriken")
	public static final EntityType arrow = null;
	public DiamondShurikenItem(ElementalmasterModElements instance) {
		super(instance, 173);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletdiamondshuriken").setRegistryName("entitybulletdiamondshuriken"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("diamondshuriken");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(DiamondShurikenItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(DiamondShurikenItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(DiamondShurikenItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected ItemStack getArrowStack() {
			return new ItemStack(DiamondShurikenItem.block, (int) (1));
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("elementalmaster:textures/diamondshuriken.png");
