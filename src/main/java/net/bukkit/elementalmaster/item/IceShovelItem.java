...
public class IceShovelItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:iceshovel")
	public static final Item block = null;
	public IceShovelItem(ElementalmasterModElements instance) {
		super(instance, 140);
	}
