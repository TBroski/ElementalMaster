...
public class IceArmorItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icearmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("elementalmaster:icearmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("elementalmaster:icearmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("elementalmaster:icearmor_boots")
	public static final Item boots = null;
	public IceArmorItem(ElementalmasterModElements instance) {
		super(instance, 142);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ElementalGearsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "elementalmaster:textures/models/armor/ice_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("icearmor_helmet"));
		...
		}.setRegistryName("icearmor_chestplate"));
		...
		}.setRegistryName("icearmor_leggings"));
		...
		}.setRegistryName("icearmor_boots"));
	}
}
