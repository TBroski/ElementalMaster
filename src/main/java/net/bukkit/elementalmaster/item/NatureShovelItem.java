...
public class NatureShovelItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:natureshovel")
	public static final Item block = null;
	public NatureShovelItem(ElementalmasterModElements instance) {
		super(instance, 167);
	}
