...
public class IceMastersArmorItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:ice_masters_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("elementalmaster:ice_masters_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("elementalmaster:ice_masters_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("elementalmaster:ice_masters_armor_boots")
	public static final Item boots = null;
	public IceMastersArmorItem(ElementalmasterModElements instance) {
		super(instance, 181);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ElementalGearsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "elementalmaster:textures/models/armor/ice_armor__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("ice_masters_armor_helmet"));
		...
		}.setRegistryName("ice_masters_armor_chestplate"));
		...
		}.setRegistryName("ice_masters_armor_leggings"));
		...
		}.setRegistryName("ice_masters_armor_boots"));
	}
}
