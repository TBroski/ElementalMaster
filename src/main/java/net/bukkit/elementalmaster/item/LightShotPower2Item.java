...
public class LightShotPower2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:light_shot_power_2")
	public static final Item block = null;
	public LightShotPower2Item(ElementalmasterModElements instance) {
		super(instance, 237);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("light_shot_power_2");
		}
