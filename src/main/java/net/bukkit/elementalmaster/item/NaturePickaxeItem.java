...
public class NaturePickaxeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:naturepickaxe")
	public static final Item block = null;
	public NaturePickaxeItem(ElementalmasterModElements instance) {
		super(instance, 165);
	}
