...
public class FireMastersArmorItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fire_masters_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("elementalmaster:fire_masters_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("elementalmaster:fire_masters_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("elementalmaster:fire_masters_armor_boots")
	public static final Item boots = null;
	public FireMastersArmorItem(ElementalmasterModElements instance) {
		super(instance, 180);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ElementalGearsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "elementalmaster:textures/models/armor/conflagrationfire_armor___layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1")
						+ ".png";
			}
		}.setRegistryName("fire_masters_armor_helmet"));
		...
		}.setRegistryName("fire_masters_armor_chestplate"));
		...
		}.setRegistryName("fire_masters_armor_leggings"));
		...
		}.setRegistryName("fire_masters_armor_boots"));
	}
}
