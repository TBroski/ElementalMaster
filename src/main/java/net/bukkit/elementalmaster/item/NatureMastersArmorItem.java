...
public class NatureMastersArmorItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:nature_masters_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("elementalmaster:nature_masters_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("elementalmaster:nature_masters_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("elementalmaster:nature_masters_armor_boots")
	public static final Item boots = null;
	public NatureMastersArmorItem(ElementalmasterModElements instance) {
		super(instance, 184);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ElementalGearsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "elementalmaster:textures/models/armor/nature_armor__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("nature_masters_armor_helmet"));
		...
		}.setRegistryName("nature_masters_armor_chestplate"));
		...
		}.setRegistryName("nature_masters_armor_leggings"));
		...
		}.setRegistryName("nature_masters_armor_boots"));
	}
}
