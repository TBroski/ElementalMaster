...
public class LightShotPower1Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:light_shot_power_1")
	public static final Item block = null;
	public LightShotPower1Item(ElementalmasterModElements instance) {
		super(instance, 236);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("light_shot_power_1");
		}
