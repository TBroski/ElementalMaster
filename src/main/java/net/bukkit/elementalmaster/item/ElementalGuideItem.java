...
import net.bukkit.elementalmaster.gui.ElementalGuideGUIPage1Gui;
...
public class ElementalGuideItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:elementalguide")
	public static final Item block = null;
	public ElementalGuideItem(ElementalmasterModElements instance) {
		super(instance, 186);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("elementalguide");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Contains all information about the mod!"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Elemental Guide");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new ElementalGuideGUIPage1Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
