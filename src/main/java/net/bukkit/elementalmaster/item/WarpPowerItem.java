...
public class WarpPowerItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:warp_power")
	public static final Item block = null;
	public WarpPowerItem(ElementalmasterModElements instance) {
		super(instance, 245);
	}
