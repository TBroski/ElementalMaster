...
public class NaturePowerItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:nature_power")
	public static final Item block = null;
	public NaturePowerItem(ElementalmasterModElements instance) {
		super(instance, 230);
	}
