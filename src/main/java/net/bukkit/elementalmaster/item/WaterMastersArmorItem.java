...
public class WaterMastersArmorItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:water_masters_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("elementalmaster:water_masters_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("elementalmaster:water_masters_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("elementalmaster:water_masters_armor_boots")
	public static final Item boots = null;
	public WaterMastersArmorItem(ElementalmasterModElements instance) {
		super(instance, 183);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ElementalGearsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "elementalmaster:textures/models/armor/water_armor__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("water_masters_armor_helmet"));
		...
		}.setRegistryName("water_masters_armor_chestplate"));
		...
		}.setRegistryName("water_masters_armor_leggings"));
		...
		}.setRegistryName("water_masters_armor_boots"));
	}
}
