...
public class EmeraldShurikenItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:emeraldshuriken")
	public static final Item block = null;
	@ObjectHolder("elementalmaster:entitybulletemeraldshuriken")
	public static final EntityType arrow = null;
	public EmeraldShurikenItem(ElementalmasterModElements instance) {
		super(instance, 172);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletemeraldshuriken").setRegistryName("entitybulletemeraldshuriken"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("emeraldshuriken");
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("elementalmaster:textures/emeraldshuriken.png");
