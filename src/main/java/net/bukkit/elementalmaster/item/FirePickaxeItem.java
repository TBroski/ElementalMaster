...
public class FirePickaxeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firepickaxe")
	public static final Item block = null;
	public FirePickaxeItem(ElementalmasterModElements instance) {
		super(instance, 131);
	}
