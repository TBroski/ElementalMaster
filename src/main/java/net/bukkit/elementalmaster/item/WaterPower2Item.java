...
public class WaterPower2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:water_power_2")
	public static final Item block = null;
	public WaterPower2Item(ElementalmasterModElements instance) {
		super(instance, 219);
	}
