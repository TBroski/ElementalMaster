...
public class XPRune2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:xprune2")
	public static final Item block = null;
	public XPRune2Item(ElementalmasterModElements instance) {
		super(instance, 115);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Gain randomly some XP more frequently when in Inventory!"));
