...
public class FireballShot1Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fireball_shot_1")
	public static final Item block = null;
	public FireballShot1Item(ElementalmasterModElements instance) {
		super(instance, 215);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fireball_shot_1");
		}
