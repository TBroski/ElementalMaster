...
public class NightVisionRuneItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:nightvisionrune")
	public static final Item block = null;
	public NightVisionRuneItem(ElementalmasterModElements instance) {
		super(instance, 110);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("nightvisionrune");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Grants you \u00A73Night Vision \u00A7fwhen in Inventory!"));
