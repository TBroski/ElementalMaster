...
public class WaterPower3Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:water_power_3")
	public static final Item block = null;
	public WaterPower3Item(ElementalmasterModElements instance) {
		super(instance, 220);
	}
