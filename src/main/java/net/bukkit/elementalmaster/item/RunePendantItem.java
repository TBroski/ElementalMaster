...
import net.bukkit.elementalmaster.gui.RuneStoringGUIGui;
...
public class RunePendantItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:rune_pendant")
	public static final Item block = null;
	public RunePendantItem(ElementalmasterModElements instance) {
		super(instance, 258);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used to store the runes if you have too much on yourself!"));
			list.add(new StringTextComponent("CURRENTLY NOT FUNCTIONAL"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Rune Pendant");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new RuneStoringGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
