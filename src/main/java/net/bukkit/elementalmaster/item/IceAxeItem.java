...
public class IceAxeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:iceaxe")
	public static final Item block = null;
	public IceAxeItem(ElementalmasterModElements instance) {
		super(instance, 139);
	}
