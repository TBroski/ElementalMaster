...
public class GoldShurikenItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:goldshuriken")
	public static final Item block = null;
	@ObjectHolder("elementalmaster:entitybulletgoldshuriken")
	public static final EntityType arrow = null;
	public GoldShurikenItem(ElementalmasterModElements instance) {
		super(instance, 171);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletgoldshuriken").setRegistryName("entitybulletgoldshuriken"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(GoldShurikenItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(GoldShurikenItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(GoldShurikenItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected ItemStack getArrowStack() {
			return new ItemStack(GoldShurikenItem.block, (int) (1));
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("elementalmaster:textures/goldshuriken.png");
