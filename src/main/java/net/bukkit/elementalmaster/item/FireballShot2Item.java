...
public class FireballShot2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fireball_shot_2")
	public static final Item block = null;
	public FireballShot2Item(ElementalmasterModElements instance) {
		super(instance, 216);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fireball_shot_2");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A74Knockback: \u00A761.25"));
