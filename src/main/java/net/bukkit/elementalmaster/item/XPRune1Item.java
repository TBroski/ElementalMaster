...
public class XPRune1Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:xprune1")
	public static final Item block = null;
	public XPRune1Item(ElementalmasterModElements instance) {
		super(instance, 114);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Gain randomly some little XP when in Inventory!"));
