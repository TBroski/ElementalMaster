...
public class HealingPower3Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:healing_power_3")
	public static final Item block = null;
	public HealingPower3Item(ElementalmasterModElements instance) {
		super(instance, 241);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("healing_power_3");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A74Heal Amount: \u00A763 heart"));
			list.add(new StringTextComponent("\u00A73Cooldown: \u00A761.5s"));
