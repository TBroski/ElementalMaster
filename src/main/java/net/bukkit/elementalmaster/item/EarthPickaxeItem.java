...
public class EarthPickaxeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:earthpickaxe")
	public static final Item block = null;
	public EarthPickaxeItem(ElementalmasterModElements instance) {
		super(instance, 159);
	}
