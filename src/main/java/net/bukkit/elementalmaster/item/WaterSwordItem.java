...
public class WaterSwordItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:watersword")
	public static final Item block = null;
	public WaterSwordItem(ElementalmasterModElements instance) {
		super(instance, 151);
	}
