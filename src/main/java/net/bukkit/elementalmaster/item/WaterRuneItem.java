...
public class WaterRuneItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:waterrune")
	public static final Item block = null;
	public WaterRuneItem(ElementalmasterModElements instance) {
		super(instance, 108);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent(
					"Grants you \u00A73Water Breathing \u00A7fand \u00A73Dolphin's Grace \u00A7funderwater when in Inventory!"));
