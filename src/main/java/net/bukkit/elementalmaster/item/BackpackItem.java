...
import net.bukkit.elementalmaster.gui.GUIBackpackGui;
...
public class BackpackItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:backpack")
	public static final Item block = null;
	public BackpackItem(ElementalmasterModElements instance) {
		super(instance, 261);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Right-Click to store up to 27 items inside!"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GUIBackpackGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
