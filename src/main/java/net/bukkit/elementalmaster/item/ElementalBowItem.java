...
import net.bukkit.elementalmaster.procedures.ElementalBowBulletHitsBlockProcedure;
...
public class ElementalBowItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:elemental_bow")
	public static final Item block = null;
	@ObjectHolder("elementalmaster:entitybulletelemental_bow")
	public static final EntityType arrow = null;
	public ElementalBowItem(ElementalmasterModElements instance) {
		super(instance, 185);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletelemental_bow").setRegistryName("entitybulletelemental_bow"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ElementalGearsItemGroup.tab).maxDamage(100));
			setRegistryName("elemental_bow");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The most powerful bow that exists!"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				ElementalBowBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
