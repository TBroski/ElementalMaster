...
public class EarthSwordItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:earthsword")
	public static final Item block = null;
	public EarthSwordItem(ElementalmasterModElements instance) {
		super(instance, 158);
	}
