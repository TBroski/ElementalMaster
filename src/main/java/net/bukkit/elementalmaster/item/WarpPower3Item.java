...
public class WarpPower3Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:warp_power_3")
	public static final Item block = null;
	public WarpPower3Item(ElementalmasterModElements instance) {
		super(instance, 247);
	}
