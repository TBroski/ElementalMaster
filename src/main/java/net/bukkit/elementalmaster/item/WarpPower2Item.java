...
public class WarpPower2Item extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:warp_power_2")
	public static final Item block = null;
	public WarpPower2Item(ElementalmasterModElements instance) {
		super(instance, 246);
	}
