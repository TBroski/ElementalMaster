...
public class FireRuneItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firerune")
	public static final Item block = null;
	public FireRuneItem(ElementalmasterModElements instance) {
		super(instance, 105);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Grants you \u00A74Fire Resistance \u00A7fand \u00A76Strength II \u00A7fwhen in Inventory!"));
