...
public class WaterAxeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:wateraxe")
	public static final Item block = null;
	public WaterAxeItem(ElementalmasterModElements instance) {
		super(instance, 153);
	}
