...
public class HealingRuneItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:healingrune")
	public static final Item block = null;
	public HealingRuneItem(ElementalmasterModElements instance) {
		super(instance, 112);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Grants you \u00A7dRegeneration \u00A7fwhen in Inventory!"));
