...
public class MagicBallPowerItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:magic_ball_power")
	public static final Item block = null;
	public MagicBallPowerItem(ElementalmasterModElements instance) {
		super(instance, 212);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_ball_power");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A74Damage: \u00A766"));
			list.add(new StringTextComponent("\u00A74Knockback: \u00A760.5"));
