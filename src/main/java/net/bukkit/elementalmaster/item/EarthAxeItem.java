...
public class EarthAxeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:earthaxe")
	public static final Item block = null;
	public EarthAxeItem(ElementalmasterModElements instance) {
		super(instance, 160);
	}
