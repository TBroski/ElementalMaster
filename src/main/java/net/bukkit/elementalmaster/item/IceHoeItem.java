...
public class IceHoeItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icehoe")
	public static final Item block = null;
	public IceHoeItem(ElementalmasterModElements instance) {
		super(instance, 141);
	}
