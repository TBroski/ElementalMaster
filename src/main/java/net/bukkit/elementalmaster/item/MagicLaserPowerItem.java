...
public class MagicLaserPowerItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:magic_laser_power")
	public static final Item block = null;
	public MagicLaserPowerItem(ElementalmasterModElements instance) {
		super(instance, 606);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_laser_power");
		}
