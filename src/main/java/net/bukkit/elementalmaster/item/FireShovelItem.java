...
public class FireShovelItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fireshovel")
	public static final Item block = null;
	public FireShovelItem(ElementalmasterModElements instance) {
		super(instance, 133);
	}
