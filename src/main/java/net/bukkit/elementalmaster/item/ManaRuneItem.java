...
public class ManaRuneItem extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:mana_rune")
	public static final Item block = null;
	public ManaRuneItem(ElementalmasterModElements instance) {
		super(instance, 127);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Grants you \u00A75Mana Regeneration II \u00A7fwhen in Inventory!"));
			list.add(new StringTextComponent("\u00A7fCan be found in Dungeons!"));
