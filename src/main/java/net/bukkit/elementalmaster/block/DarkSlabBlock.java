...
public class DarkSlabBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:darkslab")
	public static final Block block = null;
	public DarkSlabBlock(ElementalmasterModElements instance) {
		super(instance, 41);
	}
