...
public class DarkLightPlanksBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_light_planks")
	public static final Block block = null;
	public DarkLightPlanksBlock(ElementalmasterModElements instance) {
		super(instance, 693);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_light_planks");
		}
