...
public class NatureOreOverworldBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:natureoreoverworld")
	public static final Block block = null;
	public NatureOreOverworldBlock(ElementalmasterModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("natureoreoverworld");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("natureoreoverworld", "natureoreoverworld", blockAt -> {
