...
public class FieryRootsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fiery_roots")
	public static final Block block = null;
	public FieryRootsBlock(ElementalmasterModElements instance) {
		super(instance, 265);
	}
