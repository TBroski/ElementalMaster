...
public class FireBlockBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fireblock")
	public static final Block block = null;
	public FireBlockBlock(ElementalmasterModElements instance) {
		super(instance, 10);
	}
