...
public class IcyPinePlanksBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icypineplanks")
	public static final Block block = null;
	public IcyPinePlanksBlock(ElementalmasterModElements instance) {
		super(instance, 28);
	}
