...
public class FireOreOverworldBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fireoreoverworld")
	public static final Block block = null;
	public FireOreOverworldBlock(ElementalmasterModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fireoreoverworld");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("fireoreoverworld", "fireoreoverworld", blockAt -> {
