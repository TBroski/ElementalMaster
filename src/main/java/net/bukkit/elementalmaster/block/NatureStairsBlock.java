...
public class NatureStairsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:naturestairs")
	public static final Block block = null;
	public NatureStairsBlock(ElementalmasterModElements instance) {
		super(instance, 35);
	}
