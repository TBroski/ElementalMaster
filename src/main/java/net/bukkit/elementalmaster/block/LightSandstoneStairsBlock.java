...
public class LightSandstoneStairsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:light_sandstone_stairs")
	public static final Block block = null;
	public LightSandstoneStairsBlock(ElementalmasterModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("light_sandstone_stairs");
		}
