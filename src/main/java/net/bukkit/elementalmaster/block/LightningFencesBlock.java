...
public class LightningFencesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningfences")
	public static final Block block = null;
	public LightningFencesBlock(ElementalmasterModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("lightningfences");
		}
