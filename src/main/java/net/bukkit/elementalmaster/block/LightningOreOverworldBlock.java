...
public class LightningOreOverworldBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningoreoverworld")
	public static final Block block = null;
	public LightningOreOverworldBlock(ElementalmasterModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightningoreoverworld");
		}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("lightningoreoverworld", "lightningoreoverworld", blockAt -> {
