...
public class FiriumLeavesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumleaves")
	public static final Block block = null;
	public FiriumLeavesBlock(ElementalmasterModElements instance) {
		super(instance, 22);
	}
