...
public class IcyPineTrapdoorBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icypinetrapdoor")
	public static final Block block = null;
	public IcyPineTrapdoorBlock(ElementalmasterModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("icypinetrapdoor");
		}
