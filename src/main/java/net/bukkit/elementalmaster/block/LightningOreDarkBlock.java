...
public class LightningOreDarkBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightning_ore_dark")
	public static final Block block = null;
	public LightningOreDarkBlock(ElementalmasterModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightning_ore_dark");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("lightning_ore_dark", "lightning_ore_dark", blockAt -> {
