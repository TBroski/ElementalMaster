...
public class FiriumStairsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumstairs")
	public static final Block block = null;
	public FiriumStairsBlock(ElementalmasterModElements instance) {
		super(instance, 32);
	}
