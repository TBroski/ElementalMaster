...
public class NaturePlanksBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:natureplanks")
	public static final Block block = null;
	public NaturePlanksBlock(ElementalmasterModElements instance) {
		super(instance, 30);
	}
