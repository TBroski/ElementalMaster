...
public class IcyPineFencesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icypinefences")
	public static final Block block = null;
	public IcyPineFencesBlock(ElementalmasterModElements instance) {
		super(instance, 43);
	}
