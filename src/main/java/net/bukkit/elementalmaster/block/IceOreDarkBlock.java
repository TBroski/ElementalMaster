...
public class IceOreDarkBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:ice_ore_dark")
	public static final Block block = null;
	public IceOreDarkBlock(ElementalmasterModElements instance) {
		super(instance, 75);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ice_ore_dark", "ice_ore_dark", blockAt -> {
