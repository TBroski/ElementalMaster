...
public class FireStoneBrickBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fire_stone_brick")
	public static final Block block = null;
	public FireStoneBrickBlock(ElementalmasterModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fire_stone_brick");
		}
