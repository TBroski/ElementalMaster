...
public class DarkLogBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:darklog")
	public static final Block block = null;
	public DarkLogBlock(ElementalmasterModElements instance) {
		super(instance, 21);
	}
