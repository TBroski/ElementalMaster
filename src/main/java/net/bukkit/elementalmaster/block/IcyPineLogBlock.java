...
public class IcyPineLogBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icypinelog")
	public static final Block block = null;
	public IcyPineLogBlock(ElementalmasterModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.WOOD).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(0)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("icypinelog");
		}
