...
public class CloversBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:clovers")
	public static final Block block = null;
	public CloversBlock(ElementalmasterModElements instance) {
		super(instance, 270);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (ForgeRegistries.BIOMES.getKey(biome).equals(new ResourceLocation("elementalmaster:greeniliumjungle")))
				biomeCriteria = true;
