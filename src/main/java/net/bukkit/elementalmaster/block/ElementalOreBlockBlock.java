...
public class ElementalOreBlockBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:elementaloreblock")
	public static final Block block = null;
	public ElementalOreBlockBlock(ElementalmasterModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elementaloreblock");
		}
