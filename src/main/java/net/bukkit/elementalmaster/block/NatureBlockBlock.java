...
public class NatureBlockBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:natureblock")
	public static final Block block = null;
	public NatureBlockBlock(ElementalmasterModElements instance) {
		super(instance, 15);
	}
