...
public class DarkStairsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:darkstairs")
	public static final Block block = null;
	public DarkStairsBlock(ElementalmasterModElements instance) {
		super(instance, 36);
	}
