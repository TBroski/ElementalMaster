...
public class IceOreOverworldBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:iceoreoverworld")
	public static final Block block = null;
	public IceOreOverworldBlock(ElementalmasterModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("iceoreoverworld");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("iceoreoverworld", "iceoreoverworld", blockAt -> {
