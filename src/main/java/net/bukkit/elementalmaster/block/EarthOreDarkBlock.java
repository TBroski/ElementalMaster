...
public class EarthOreDarkBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:earth_ore_dark")
	public static final Block block = null;
	public EarthOreDarkBlock(ElementalmasterModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("earth_ore_dark");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("earth_ore_dark", "earth_ore_dark", blockAt -> {
