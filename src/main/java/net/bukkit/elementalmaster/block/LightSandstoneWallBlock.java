...
public class LightSandstoneWallBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:light_sandstone_wall")
	public static final Block block = null;
	public LightSandstoneWallBlock(ElementalmasterModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("light_sandstone_wall");
		}
