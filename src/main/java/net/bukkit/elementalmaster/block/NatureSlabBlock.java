...
public class NatureSlabBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:natureslab")
	public static final Block block = null;
	public NatureSlabBlock(ElementalmasterModElements instance) {
		super(instance, 40);
	}
