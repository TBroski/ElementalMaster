...
public class LightningBlockBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningblock")
	public static final Block block = null;
	public LightningBlockBlock(ElementalmasterModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightningblock");
		}
