...
public class DarkLightWoodBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_light_wood")
	public static final Block block = null;
	public DarkLightWoodBlock(ElementalmasterModElements instance) {
		super(instance, 692);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dark_light_wood");
		}
