...
public class LightningStairsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningstairs")
	public static final Block block = null;
	public LightningStairsBlock(ElementalmasterModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.WOOD).sound(SoundType.WOOD)
					.hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(0).harvestTool(ToolType.AXE).notSolid());
			setRegistryName("lightningstairs");
		}
