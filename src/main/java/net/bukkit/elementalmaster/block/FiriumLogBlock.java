...
public class FiriumLogBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumlog")
	public static final Block block = null;
	public FiriumLogBlock(ElementalmasterModElements instance) {
		super(instance, 17);
	}
