...
public class OrangeFlowerBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:orange_flower")
	public static final Block block = null;
	public OrangeFlowerBlock(ElementalmasterModElements instance) {
		super(instance, 267);
	}
