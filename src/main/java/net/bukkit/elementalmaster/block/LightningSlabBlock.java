...
public class LightningSlabBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningslab")
	public static final Block block = null;
	public LightningSlabBlock(ElementalmasterModElements instance) {
		super(instance, 39);
	}
