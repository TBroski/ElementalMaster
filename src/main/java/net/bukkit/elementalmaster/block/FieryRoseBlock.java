...
public class FieryRoseBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fieryrose")
	public static final Block block = null;
	public FieryRoseBlock(ElementalmasterModElements instance) {
		super(instance, 263);
	}
