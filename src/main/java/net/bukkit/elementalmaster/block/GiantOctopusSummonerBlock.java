...
public class GiantOctopusSummonerBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:giant_octopus_summoner")
	public static final Block block = null;
	public GiantOctopusSummonerBlock(ElementalmasterModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("giant_octopus_summoner");
		}
