...
public class UnbreakableFireBrickBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:unbreakable_fire_brick")
	public static final Block block = null;
	public UnbreakableFireBrickBlock(ElementalmasterModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unbreakable_fire_brick");
		}
