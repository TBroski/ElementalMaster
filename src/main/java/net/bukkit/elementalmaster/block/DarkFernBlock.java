...
public class DarkFernBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_fern")
	public static final Block block = null;
	public DarkFernBlock(ElementalmasterModElements instance) {
		super(instance, 266);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0.5f).lightValue(5));
			setRegistryName("dark_fern");
		}
