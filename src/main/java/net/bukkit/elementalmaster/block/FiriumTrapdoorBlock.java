...
public class FiriumTrapdoorBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumtrapdoor")
	public static final Block block = null;
	public FiriumTrapdoorBlock(ElementalmasterModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("firiumtrapdoor");
		}
