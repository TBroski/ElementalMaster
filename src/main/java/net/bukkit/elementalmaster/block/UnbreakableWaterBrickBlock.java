...
public class UnbreakableWaterBrickBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:unbreakable_water_brick")
	public static final Block block = null;
	public UnbreakableWaterBrickBlock(ElementalmasterModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unbreakable_water_brick");
		}
