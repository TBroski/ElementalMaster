...
public class FieryGrassBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:fiery_grass")
	public static final Block block = null;
	public FieryGrassBlock(ElementalmasterModElements instance) {
		super(instance, 268);
	}
