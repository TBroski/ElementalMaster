...
public class SnowyFlowerBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:snowyflower")
	public static final Block block = null;
	public SnowyFlowerBlock(ElementalmasterModElements instance) {
		super(instance, 264);
	}
