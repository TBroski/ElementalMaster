...
public class NatureTrapdoorBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:naturetrapdoor")
	public static final Block block = null;
	public NatureTrapdoorBlock(ElementalmasterModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("naturetrapdoor");
		}
