...
public class WaterBlockBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:waterblock")
	public static final Block block = null;
	public WaterBlockBlock(ElementalmasterModElements instance) {
		super(instance, 13);
	}
