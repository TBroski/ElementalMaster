...
public class FiriumPlanksBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumplanks")
	public static final Block block = null;
	public FiriumPlanksBlock(ElementalmasterModElements instance) {
		super(instance, 27);
	}
