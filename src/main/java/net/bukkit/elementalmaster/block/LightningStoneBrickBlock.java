...
public class LightningStoneBrickBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightning_stone_brick")
	public static final Block block = null;
	public LightningStoneBrickBlock(ElementalmasterModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightning_stone_brick");
		}
