...
import net.bukkit.elementalmaster.gui.MasterStationUpgradeGui;
...
public class MasterStationBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:master_station")
	public static final Block block = null;
	public MasterStationBlock(ElementalmasterModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("master_station");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Master Station");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new MasterStationUpgradeGui.GuiContainerMod(id, inventory,
