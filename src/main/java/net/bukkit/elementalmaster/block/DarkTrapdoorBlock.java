...
public class DarkTrapdoorBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:darktrapdoor")
	public static final Block block = null;
	public DarkTrapdoorBlock(ElementalmasterModElements instance) {
		super(instance, 51);
	}
