...
public class NatureLogBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:naturelog")
	public static final Block block = null;
	public NatureLogBlock(ElementalmasterModElements instance) {
		super(instance, 20);
	}
