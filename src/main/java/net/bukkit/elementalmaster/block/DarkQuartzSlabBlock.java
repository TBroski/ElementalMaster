...
public class DarkQuartzSlabBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_quartz_slab")
	public static final Block block = null;
	public DarkQuartzSlabBlock(ElementalmasterModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_quartz_slab");
		}
