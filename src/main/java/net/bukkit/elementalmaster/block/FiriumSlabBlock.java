...
public class FiriumSlabBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumslab")
	public static final Block block = null;
	public FiriumSlabBlock(ElementalmasterModElements instance) {
		super(instance, 37);
	}
