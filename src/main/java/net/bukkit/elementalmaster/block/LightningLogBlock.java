...
public class LightningLogBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightninglog")
	public static final Block block = null;
	public LightningLogBlock(ElementalmasterModElements instance) {
		super(instance, 19);
	}
