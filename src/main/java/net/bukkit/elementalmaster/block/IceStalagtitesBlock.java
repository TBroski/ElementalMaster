...
import net.bukkit.elementalmaster.procedures.IsThereBlockAboveProcedure;
...
public class IceStalagtitesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:ice_stalagtites")
	public static final Block block = null;
	public IceStalagtitesBlock(ElementalmasterModElements instance) {
		super(instance, 687);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(0.7999999999999999f, 10f).lightValue(0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).slipperiness(0.7999999999999999f).notSolid());
			setRegistryName("ice_stalagtites");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			return VoxelShapes.create(0.1D, 0.1D, 0.1D, 0.9D, 1D, 0.9D);
		}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!IsThereBlockAboveProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
					return super.place(world, generator, rand, pos, config);
				}
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("ice_stalagtites", "ice_stalagtites", blockAt -> {
			...
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(32, 9, 9, 64))));
		}
	}
}
