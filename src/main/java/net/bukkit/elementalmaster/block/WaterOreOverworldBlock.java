...
public class WaterOreOverworldBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:wateroreoverworld")
	public static final Block block = null;
	public WaterOreOverworldBlock(ElementalmasterModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wateroreoverworld");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("wateroreoverworld", "wateroreoverworld", blockAt -> {
