...
public class WaterOreDarkBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:water_ore_dark")
	public static final Block block = null;
	public WaterOreDarkBlock(ElementalmasterModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("water_ore_dark");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("water_ore_dark", "water_ore_dark", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == DarkStoneBlock.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 6)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(8, 0, 0, 64))));
		}
	}
}
