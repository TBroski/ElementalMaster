...
public class PackedIceGenerateBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:packed_ice_generate")
	public static final Block block = null;
	public PackedIceGenerateBlock(ElementalmasterModElements instance) {
		super(instance, 689);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("packed_ice_generate");
		}
		...
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("packed_ice_generate", "packed_ice_generate", blockAt -> {
						boolean blockCriteria = false;
						if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
							blockCriteria = true;
						return blockCriteria;
					}), block.getDefaultState(), 26)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(26, 16, 16, 64))));
		}
	}
}
