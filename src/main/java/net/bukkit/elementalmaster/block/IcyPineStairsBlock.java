...
public class IcyPineStairsBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icypinestairs")
	public static final Block block = null;
	public IcyPineStairsBlock(ElementalmasterModElements instance) {
		super(instance, 33);
	}
