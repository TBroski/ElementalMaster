...
public class EarthBlockBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:earthblock")
	public static final Block block = null;
	public EarthBlockBlock(ElementalmasterModElements instance) {
		super(instance, 14);
	}
