...
public class WaterStoneBrickBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:water_stone_brick")
	public static final Block block = null;
	public WaterStoneBrickBlock(ElementalmasterModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("water_stone_brick");
		}
