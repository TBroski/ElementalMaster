...
public class LightningPlanksBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningplanks")
	public static final Block block = null;
	public LightningPlanksBlock(ElementalmasterModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightningplanks");
		}
