...
public class DarkQuartzPillarBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:dark_quartz_pillar")
	public static final Block block = null;
	public DarkQuartzPillarBlock(ElementalmasterModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dark_quartz_pillar");
		}
