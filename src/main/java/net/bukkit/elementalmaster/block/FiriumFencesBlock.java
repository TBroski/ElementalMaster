...
public class FiriumFencesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:firiumfences")
	public static final Block block = null;
	public FiriumFencesBlock(ElementalmasterModElements instance) {
		super(instance, 42);
	}
