...
public class LightningTrapdoorBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:lightningtrapdoor")
	public static final Block block = null;
	public LightningTrapdoorBlock(ElementalmasterModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("lightningtrapdoor");
		}
