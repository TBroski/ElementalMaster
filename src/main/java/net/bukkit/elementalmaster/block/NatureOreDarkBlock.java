...
public class NatureOreDarkBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:nature_ore_dark")
	public static final Block block = null;
	public NatureOreDarkBlock(ElementalmasterModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nature_ore_dark");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("nature_ore_dark", "nature_ore_dark", blockAt -> {
