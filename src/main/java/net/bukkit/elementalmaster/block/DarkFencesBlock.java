...
public class DarkFencesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:darkfences")
	public static final Block block = null;
	public DarkFencesBlock(ElementalmasterModElements instance) {
		super(instance, 46);
	}
