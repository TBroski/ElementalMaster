...
public class IcyPineSlabBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icypineslab")
	public static final Block block = null;
	public IcyPineSlabBlock(ElementalmasterModElements instance) {
		super(instance, 38);
	}
