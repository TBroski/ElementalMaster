...
public class NatureFencesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:naturefences")
	public static final Block block = null;
	public NatureFencesBlock(ElementalmasterModElements instance) {
		super(instance, 45);
	}
