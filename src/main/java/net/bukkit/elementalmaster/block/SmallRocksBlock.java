...
public class SmallRocksBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:smallrocks")
	public static final Block block = null;
	public SmallRocksBlock(ElementalmasterModElements instance) {
		super(instance, 54);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.STONE)
					.hardnessAndResistance(0.05f, 0f).lightValue(0));
			setRegistryName("smallrocks");
		}
