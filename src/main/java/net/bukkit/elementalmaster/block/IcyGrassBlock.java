...
public class IcyGrassBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:icy_grass")
	public static final Block block = null;
	public IcyGrassBlock(ElementalmasterModElements instance) {
		super(instance, 269);
	}
