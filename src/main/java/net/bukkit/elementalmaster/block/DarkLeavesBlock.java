...
public class DarkLeavesBlock extends ElementalmasterModElements.ModElement {
	@ObjectHolder("elementalmaster:darkleaves")
	public static final Block block = null;
	public DarkLeavesBlock(ElementalmasterModElements instance) {
		super(instance, 26);
	}
